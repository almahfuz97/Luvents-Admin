...
public class CreateModel {
    ...
    public CreateModel(String hostedBy,String eventName, String address, String description, String imgUri, String eventId, int year, int month, int date, int eYear, int eMonth, int eDate, int hour, int min, int eHour, int eMin, long create_at,long interested) {
