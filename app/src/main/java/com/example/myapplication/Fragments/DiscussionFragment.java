...
import com.example.myapplication.Classes.ImageHeightWidth;
import com.example.myapplication.Models.PostModel;
import com.example.myapplication.R;
import com.example.myapplication.activities.CommentsActivity;
...
public class DiscussionFragment extends Fragment implements View.OnClickListener{
  ...
  progressDialogueSave =new ProgressDialog(getContext());
                ...
                firebaseFirestore.collection("Events").document(postModel2.getEventId()).collection("AllPosts").document(postModel2.getPostId())
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            if (uid.equals(mAuth.getCurrentUser().getUid()) | !uid.equals(mAuth.getCurrentUser().getUid()))
                            {
      ...
      //  View mView=LayoutInflater.from(getContext()).inflate(R.layout.edit_post_alert_dialogue,null);
        ...
        editTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alertDialog.cancel();
                Toast.makeText(getContext(),"edit kortayni",Toast.LENGTH_LONG).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==PICK_IMAGE_REQUEST && resultCode== Activity.RESULT_OK && data!=null && data.getData()!=null)
        {
           ...
           // Toast.makeText( getContext(),mUri.toString(),Toast.LENGTH_LONG).show();
            ...
            {
                Picasso.get().load(mUri).fit().into(editPostImageview);
            }
    ...
    private void setPostToDatabase() {
        ...
        PostModel postModel=new PostModel(hostedBy,mCaption,imageUri,mAuth.getUid(),"","No Image",eventId,0,0,System.currentTimeMillis(),imageHeightWidth);
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        if (task.isSuccessful()) {
                            ...
                            PostModel postModel2 = new PostModel(hostedBy, mCaption, imageUri, mAuth.getUid(), task.getResult().getId(), "No Image",eventId, 0, 0, System.currentTimeMillis(),imageHeightWidth);
...
//                                        fragmentTransaction.replace(R.id.viewPagerId, fragment);
