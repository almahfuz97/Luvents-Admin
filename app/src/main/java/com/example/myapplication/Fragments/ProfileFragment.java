...
import com.example.myapplication.activities.ProfileEditActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private TextView editProfileTv,profileNameTv,emailTv, departmentNameTv,contactTv;
    ProgressBar progressBar;

    FirebaseFirestore firebaseFirestore;
    FirebaseAuth mAuth;
    String profileImgUri,profileName,email,departmentName="",contact="";
...
// Inflate the layout for this fragment
        ...
        departmentNameTv =view.findViewById(R.id.profileFragUniversityTvId);
        ...
        firebaseFirestore.collection("Admins")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.getResult()!=null)
                {
                    ...
                    profileName=task.getResult().getString("name");
                    email=task.getResult().getString("email");
                    departmentName=task.getResult().getString("departmentName");
                    ...
                    if (!departmentName.equals("")) departmentNameTv.setText(departmentName);
        ...
        editProfileTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("universityName",departmentName);
