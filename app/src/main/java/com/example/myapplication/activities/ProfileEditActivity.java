...
public class ProfileEditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialEditText profileNameTv, departmentNameTv, contactTv;

    String profileName, email, departmentName = "", contact = "", imgUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        departmentNameTv = findViewById(R.id.editProfileUniversityNameEt);
    ...
    private void uploadImage() {
        ...
        departmentName = departmentNameTv.getText().toString().trim();
        contact=contactTv.getText().toString().trim();

        if (departmentName.isEmpty()) departmentName ="";
