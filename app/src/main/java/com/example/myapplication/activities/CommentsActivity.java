...
import com.example.myapplication.Fragments.DiscussionFragment;
...
public class CommentsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadComment() {
       ...
       // progressBar.setVisibility(View.VISIBLE);
        ...
        CommentModel commentModel=new CommentModel("No Image",hostedId,comment,"cmnt id",mAuth.getUid(),System.currentTimeMillis());
        ...
        collectionReference.add(commentModel).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
            ...
            public void onComplete(@NonNull Task<DocumentReference> task) {
                ...
                {
                    final CommentModel commentModel1=new CommentModel("No Image",hostedId,comment,task.getResult().getId(),mAuth.getUid(),System.currentTimeMillis());
                    collectionReference.document(task.getResult().getId()).set(commentModel1).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
        ...
        databaseComment.child(eventId).child(postId).push().setValue(commentModel);
        settingToTheViews();
    ...
    private void longItemClickListener(final CommentAdapter commentAdapter) {
        ...
        commentAdapter.setOnLongItemClickListener(new CommentAdapter.OnLongItemClickListener() {
            @Override
            public void onLongItemClick(View view, int position, CommentModel commentModel) {
